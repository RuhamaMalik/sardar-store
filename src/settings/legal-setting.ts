export const legalSetting = [
  ...
  },
  {
    id: '2',
    title: 'Amendments',
    description: `<p>REDQ Team. BoroBazar reserves the right, at its sole discretion, to modify or replace the terms of this Agreement at any time. If the alterations constitute a material change, REDQ may or may not notify you by posting an announcement on this website. What constitutes a material change will be determined at REDQ's sole discretion. You shall be responsible for reviewing and becoming familiar with any such modifications. Using our Services following notification of a material change to this Agreement shall constitute your acceptance of the Agreement as modified.</p>`,
  },
  {
    id: '3',
    title: 'Product Compatibility/Updates',
    description: `<p>Our template BoroBazar and template associated plugins are designed to be compatible with the latest available version of WordPress. Our templates and plugins support the latest modern web browsers including (but not limited to) Chrome, Safari and Firefox. We do not offer support for Internet Explorer for any of our template.</p>`,
  },
  {
    id: '4',
    title: 'Limitation of Liability',
    description: `<p>Under no circumstances shall REDQ will be liable for any direct, indirect, special, incidental or consequential damages, including, but not limited to, loss of data or profit, arising out of the use, or the inability to use, the materials on this site, even if REDQ or an authorized representative has been advised of the possibility of such damages. If your use of materials from this site results in the need for servicing, repair, or correction of equipment or data, you assume any costs thereof.</p>`,
  },
  {
    id: '5',
    title: 'Modifications',
    description: `<p>You are allowed to modify any of our products according to your requirements.Modifications made directly inside the plugin or template will void the support license. REDQ will not be bound to offer support for customized installations. Also, additional costs may occur to provide support of the customizations that you have made.</p>`,
  },
  {
    id: '6',
